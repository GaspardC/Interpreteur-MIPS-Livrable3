...
/*
 * strdup is defined in the string.h header but included only for glibc
 * >=2.12. the following declaration bypasses the version declaration
 */
 ...
 */
int 
attach_scn_to_mem(mem vm, char *name, uint32_t attr)
{
